			...
			<div class="wrap-login100">
					...
					<div class="container-login100-form-btn">
						<div class="wrap-login100-form-btn">
							...
							<button class="login100-form-btn" name="submitRegister">
								Sign Up
							</button>
						</div>
					</div>
...
<!--===============================================================================================-->
    ...
    if ($conpassword==$password) {   
            ...
            $sql_reg="INSERT INTO `userdata`(`username`,`password`) VALUES ('$username','$md5pass')";  
            $res= mysqli_query($conn,$sql_reg);
            echo $sql_reg;
            if($res==1)header("Location:loginform.php");    
        }else {
            echo "<br>กรอกข้อมูล password ไม่ตรงกัน <br>";
